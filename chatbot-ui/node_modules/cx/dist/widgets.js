...
function tooltipMouseMove$1(e, parentInstance, tooltip, options) {
	...
	return impl$1 && impl$1.tooltipMouseMove.apply(impl$1, arguments);
}
function tooltipMouseLeave$1(e, parentInstance, tooltip, options) {
	return impl$1 && impl$1.tooltipMouseLeave.apply(impl$1, arguments);
}
function tooltipParentDidMount$1(element, parentInstance, tooltip, options) {
	return impl$1 && impl$1.tooltipParentDidMount.apply(impl$1, arguments);
}
function tooltipParentWillReceiveProps$1(element, parentInstance, tooltip, options) {
	return impl$1 && impl$1.tooltipParentWillReceiveProps.apply(impl$1, arguments);
}
function tooltipParentWillUnmount$1(parentInstance) {
	return impl$1 && impl$1.tooltipParentWillUnmount.apply(impl$1, arguments);
}
function tooltipParentDidUpdate$1(element, parentInstance, tooltip) {
	return impl$1 && impl$1.tooltipParentDidUpdate.apply(impl$1, arguments);
}
...
var ContainerComponent = /*#__PURE__*/ (function (_VDOM$Component) {
	...
	_proto2.UNSAFE_componentWillReceiveProps = function UNSAFE_componentWillReceiveProps(props) {
		tooltipParentWillReceiveProps$1(this.el, props.instance, this.props.instance.widget.tooltip);
	};
	_proto2.componentDidMount = function componentDidMount() {
		tooltipParentDidMount$1(this.el, this.props.instance, this.props.instance.widget.tooltip);
		autoFocus(this.el, this);
	};
	_proto2.componentDidUpdate = function componentDidUpdate() {
		tooltipParentDidUpdate$1(this.el, this.props.instance, this.props.instance.widget.tooltip);
		autoFocus(this.el, this);
	};
...
var HighlightedSearchText = /*#__PURE__*/ (function (_Widget) {
	...
	_proto.render = function render(context, instance, key) {
		...
		if (!chunks && text && query) {
			var highlighter = getSearchQueryHighlighter(query, {
				cache: true,
			});
...
var Dropdown = /*#__PURE__*/ (function (_Overlay) {
	...
	_proto.setDirectionClass = function setDirectionClass(component, placement) {
		...
		component.setCSSState(_extends({}, state, ((_extends2 = {}), (_extends2["place-" + placement] = true), _extends2)));
	};
...
function enableTooltips() {
	wireTooltipOps({
		...
		tooltipParentDidMount: tooltipParentDidMount,
		tooltipParentWillReceiveProps: tooltipParentWillReceiveProps,
		tooltipParentWillUnmount: tooltipParentWillUnmount,
		tooltipParentDidUpdate: tooltipParentDidUpdate,
	});
}
...
var openContextMenu = function openContextMenu(e, content, storeOrInstance, options) {
	e.preventDefault();
	e.stopPropagation();
...
var LinkButton = /*#__PURE__*/ (function (_Button) {
	...
	_proto.prepareData = function prepareData(context, instance) {
		...
		if (active) {
			...
			if (data.activeStyle) data.style = _extends({}, data.style, parseStyle(data.activeStyle));
		} else {
			if (data.inactiveClass) data.classNames += " " + data.inactiveClass;
			if (data.inactiveStyle) data.style = _extends({}, data.style, parseStyle(data.inactiveStyle));
		}
	};
...
var Input$2 = /*#__PURE__*/ (function (_VDOM$Component) {
	...
	_proto2.onMouseMove = function onMouseMove(e) {
		tooltipMouseMove$1.apply(void 0, [e].concat(getFieldTooltip(this.props.instance)));
	};
	_proto2.onMouseLeave = function onMouseLeave(e) {
		tooltipMouseLeave$1.apply(void 0, [e].concat(getFieldTooltip(this.props.instance)));
	};
	_proto2.componentDidMount = function componentDidMount() {
		tooltipParentDidMount$1.apply(void 0, [this.input].concat(getFieldTooltip(this.props.instance)));
...
var SelectComponent = /*#__PURE__*/ (function (_VDOM$Component) {
	...
	_proto2.componentDidMount = function componentDidMount() {
		...
		tooltipParentDidMount$1.apply(void 0, [this.select].concat(getFieldTooltip(this.props.instance)));
	...
	_proto2.UNSAFE_componentWillReceiveProps = function UNSAFE_componentWillReceiveProps(props) {
		tooltipParentWillReceiveProps$1.apply(void 0, [this.select].concat(getFieldTooltip(props.instance)));
	};
...
var validationCheck$1 = function validationCheck(date, data, disabledDaysOfWeek) {
	...
	if (data.dayData) {
		var day = data.dayData[date.toDateString()];
...
var LookupField = /*#__PURE__*/ (function (_Field) {
	...
	_proto.prepareData = function prepareData(context, instance) {
		...
		if (this.onCreateVisibleOptionsFilter && isArray(data.options)) {
			var filterPredicate = instance.invoke("onCreateVisibleOptionsFilter", data.filterParams, instance);
		...
		if (this.multiple) {
			...
			if (isArray(data.values) && isArray(data.options)) {
				...
				data.records = [];
				for (var i = 0; i < data.selectedKeys.length; i++) if (map[i]) data.records.push(map[i]);
...
var LookupComponent = /*#__PURE__*/ (function (_VDOM$Component) {
		...
		return /*#__PURE__*/ jsxs("div", {
			...
			children: [
				/*#__PURE__*/ jsx("div", {
					...
					onMouseMove: function onMouseMove(e) {
						return tooltipMouseMove$1.apply(void 0, [e].concat(getFieldTooltip(_this9.props.instance)));
					},
					onMouseLeave: function onMouseLeave(e) {
						return tooltipMouseLeave$1.apply(void 0, [e].concat(getFieldTooltip(_this9.props.instance)));
					},
					onClick: function onClick(e) {
     ...
     */
		...
		if (isArray(data.visibleOptions)) {
			var results = widget.filterOptions(this.props.instance, data.visibleOptions, q);
			this.setState({
				options: results,
				status: "loaded",
			});
	...
	_proto3.UNSAFE_componentWillReceiveProps = function UNSAFE_componentWillReceiveProps(props) {
		tooltipParentWillReceiveProps$1.apply(void 0, [this.dom.input].concat(getFieldTooltip(props.instance)));
	};
	_proto3.componentDidMount = function componentDidMount() {
		tooltipParentDidMount$1.apply(void 0, [this.dom.input].concat(getFieldTooltip(this.props.instance)));
			...
			children: [
				/*#__PURE__*/ jsx(
					...
					_extends(
						...
						{
							onMouseMove: function onMouseMove(e) {
								return tooltipMouseMove$1.apply(void 0, [e].concat(getFieldTooltip(_this2.props.instance)));
							},
							onMouseLeave: function onMouseLeave(e) {
								return tooltipMouseLeave$1.apply(void 0, [e].concat(getFieldTooltip(_this2.props.instance)));
							},
							onChange: function onChange(e) {
...
var MonthPickerComponent = /*#__PURE__*/ (function (_VDOM$Component) {
	...
	_proto2.componentDidMount = function componentDidMount() {
		...
		tooltipParentDidMount$1.apply(void 0, [this.dom.el].concat(getFieldTooltip(this.props.instance)));
	...
	_proto2.UNSAFE_componentWillReceiveProps = function UNSAFE_componentWillReceiveProps(props) {
		...
		tooltipParentWillReceiveProps$1.apply(void 0, [this.dom.el].concat(getFieldTooltip(props.instance)));
	};
	_proto2.componentWillUnmount = function componentWillUnmount() {
		offFocusOut(this);
		tooltipParentWillUnmount$1(this.props.instance);
...
var MonthInput = /*#__PURE__*/ (function (_VDOM$Component) {
	...
	_proto2.UNSAFE_componentWillReceiveProps = function UNSAFE_componentWillReceiveProps(props) {
		...
		tooltipParentWillReceiveProps$1.apply(void 0, [this.input].concat(getFieldTooltip(this.props.instance)));
	};
	_proto2.componentDidMount = function componentDidMount() {
		tooltipParentDidMount$1.apply(void 0, [this.input].concat(getFieldTooltip(this.props.instance)));
		autoFocus(this.input, this);
	...
	_proto2.getDropdown = function getDropdown() {
		...
		var dropdown = _extends(
			...
			widget.dropdownOptions,
			{
				...
				dismissAfterScroll: function dismissAfterScroll() {
					_this2.closeDropdown();
				},
...
var SliderComponent = /*#__PURE__*/ (function (_VDOM$Component) {
									...
									widget.showFrom &&
										/*#__PURE__*/ jsx(
											"div",
											{
												...
												onMouseMove: function onMouseMove(e) {
													return tooltipMouseMove$1(e, instance, widget.fromTooltip, {
									...
									widget.showTo &&
										/*#__PURE__*/ jsx(
											"div",
											{
												...
												onMouseMove: function onMouseMove(e) {
													return tooltipMouseMove$1(e, instance, widget.toTooltip, {
	...
	_proto2.onHandleMouseDown = function onHandleMouseDown(e, handle) {
		...
		captureMouseOrTouch(
			e,
			function (e) {
				var _this4$getValues = _this4.getValues(e, widget.vertical ? dy : dx),
					value = _this4$getValues.value;
				if (handle === "from") {
...
var Switch = /*#__PURE__*/ (function (_Field) {
	...
	_proto.renderInput = function renderInput(context, instance, key) {
		...
		var CSS = this.CSS,
			baseClass = this.baseClass;
		var text = data.text || this.renderChildren(context, instance);
		var renderTextElement = (text == null ? void 0 : text.length) != 0;
		return /*#__PURE__*/ jsxs(
			"div",
			{
				className: data.classNames,
...
var _excluded = ["value", "step", "format", "encoding", "onSelect"];
...
var Grid = /*#__PURE__*/ (function (_Container) {
								...
								if (
									(hdinstPrev.widget.resizable ||
										((_headerPrev = headerPrev) != null &&
											(_headerPrev = _headerPrev.data) != null &&
											_headerPrev.resizable)) &&
									((_headerPrev2 = headerPrev) == null || (_headerPrev2 = _headerPrev2.data) == null
										? void 0
										: _headerPrev2.colSpan) < 2
								) {
						...
						result[l].push(
							/*#__PURE__*/ jsxs(
								"th",
								{
									...
									onMouseLeave: function onMouseLeave(e) {
										return _this3.onHeaderMouseLeave(e, hdinst, l);
									},
									onClick: function onClick(e) {
	...
	_proto.onHeaderMouseMove = function onHeaderMouseMove(e, column, columnInstance, gridInstance, headerLine) {
		...
		if ((_headerInstance$widge = headerInstance.widget) != null && _headerInstance$widge.tooltip) {
	...
	_proto.onHeaderMouseLeave = function onHeaderMouseLeave(e, columnInstance, headerLine) {
		var _headerInstance$widge2;
		var headerInstance = columnInstance.components["header" + (headerLine + 1)];
		if (!headerInstance) return;
		if ((_headerInstance$widge2 = headerInstance.widget) != null && _headerInstance$widge2.tooltip) {
...
var GridComponent = /*#__PURE__*/ (function (_VDOM$Component) {
				...
				"div",
				{
					...
					children: /*#__PURE__*/ jsx("div", {
						...
						children: /*#__PURE__*/ jsxs("table", {
							ref: function ref(el) {
								_this7.dom.table = el;
								if (_this7.props.instance.widget.onRef)
									_this7.props.instance.invoke("onRef", el, _this7.props.instance);
							},
	...
	_proto2.moveCursor = function moveCursor(index, _temp) {
		...
		_ref6.hover;
		var scrollIntoView = _ref6.scrollIntoView,
			select = _ref6.select,
	...
	_proto2.beginDragDrop = function beginDragDrop(e, record) {
		...
		var widget = instance.widget,
			store = instance.store;
		var isRecordDraggable = instance.isRecordDraggable;
		...
		var add = function add(rec, data, index, force) {
			...
			var mappedRecord = rec ? _extends({}, rec) : widget.mapRecord(null, instance, data, index);
...
var GridColumnHeader = /*#__PURE__*/ (function (_Widget) {
	...
	_proto4.initComponents = function initComponents() {
		return _Widget.prototype.initComponents.call(this, {
	...
	for (var _r = 0; _r < rowCount; _r++) {
		...
		if (_tr) {
			for (var _i2 = 0; _i2 < _tr.children.length; _i2++) {
				...
				var _h2 = 0;
				for (var x = 0; x < _td2.rowSpan; x++) _h2 += rowHeight[_r + x];
		...
		if (_tr2) {
			for (var _i3 = 0; _i3 < _tr2.children.length; _i3++) {
				...
				var _h3 = 0;
				for (var _x = 0; _x < _td3.rowSpan; _x++) _h3 += rowHeight[_r + _x];
...
var DragSourceComponent = /*#__PURE__*/ (function (_VDOM$Component) {
	...
	_proto2.render = function render() {
		...
		if (this.state.dragged) {
			...
			if (data.draggedStyle) style = _extends({}, style, data.draggedStyle);
		}
		var eventHandlers = _extends({}, instance.getJsxEventProps(), {
			onTouchStart: this.onMouseDown,
			onMouseDown: this.onMouseDown,
